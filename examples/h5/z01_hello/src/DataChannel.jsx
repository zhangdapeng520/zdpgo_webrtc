...
let localConnection; // 本地连接对象
let remoteConnection; // 远端连接对象
let sendChannel; // 发送通道
let receiveChannel; // 接收通道
...
class DataChannel extends React.Component {
    ...
    sendData = () => {
        let dataChannelSend = this.refDataChannelSend;
    ...
    onReceiveMessageCallback = (event) => {
        ...
        let dataChannelReceive = this.refDataChannelReceive;
        ...
        return (
            <div className="container">
                <div>
                    <div>
                        <h2>发送</h2>
                        <textarea ref={(el) => this.refDataChannelSend = el} disabled={false}
                                  placeholder="请输入要发送的文本..."/>
                    </div>
                    <div>
                        <h2>接收</h2>
                        <textarea ref={(el) => this.refDataChannelReceive = el} disabled={false}/>
                    </div>
                </div>
                <div>
