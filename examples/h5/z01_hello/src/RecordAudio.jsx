...
class RecordAudio extends React.Component {
    ...
    componentDidMount() {
        audioPlayer = this.refAudioPlayer; // 获取音频播放器
    }
    ...
    startRecordButtonClickHandler = (e) => {
        ...
        mediaRecorder.onstop = (event) => {
            console.log('停止录制: ', event);
            console.log('录制数据: ', recordedBlobs);
        };
        ...
        console.log('开始录制音频数据：', mediaRecorder);
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                {/* 音频播放器,播放录制音频 */}
                <audio ref={(el) => this.refAudioPlayer = el} controls autoPlay/>
