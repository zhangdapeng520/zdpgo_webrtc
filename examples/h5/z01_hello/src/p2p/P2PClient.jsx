                                    ...
                                    return (
                                        <List.Item key={user.id}>
                                            <div className="list-item">
                                                ...
                                                <div>
                                                    <Button type="link"
                                                            onClick={() => this.handleStartCall(user.id, 'video')}>视频</Button>
                                                    <Button type="link"
                                                            onClick={() => this.handleStartCall(user.id, 'screen')}>共享桌面</Button>
                                                </div>
                                                }
                                            </div>
                                        </List.Item>
                            ...
                            <div>
                                ...
                                }
                                {
                                    ...
                                    this.state.localStream != null ?
                                        <LocalVideoView stream={this.state.localStream} muted={this.state.videoMuted}
                                                        id={'localview'}/> : null
                                }
                            </div>
